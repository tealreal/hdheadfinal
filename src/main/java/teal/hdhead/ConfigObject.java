...
public final class ConfigObject {
    ...
    public Integer[] getScaleInject() {
        return scaleInject;
    }
    public void setScaleInject(Integer[] i) { scaleInject = i; }
    ...
    public ConfigObject() {
        ...
        // scaleInject
        scaleInject = new Integer[]{-1, -1, 1};
        // merge
        merge = false;
        // hash
        hash = true;

        // max size (50 MB in bytes)
        thresholdSize = 50000000;
